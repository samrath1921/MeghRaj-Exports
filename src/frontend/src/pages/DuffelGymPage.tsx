...
const category = phase1Categories.find((c) => c.id === 'duffel-gym')!;

const customOptions = [
  'Logo via embroidery, screen print, or heat transfer',
  'Custom colour, Pantone matching available',
  'Fabric: polyester, nylon, canvas, or PVC-coated',
  'Zipper: YKK or equivalent, waterproof options',
  'Ventilated mesh panels and wet-dry separation',
  'Hardware: D-rings, trolley straps, adjustable straps',
  'Labels: woven, leather patch, or printed',
  'Packaging: individual poly bags, gift box, hang tag',
];

export default function DuffelGymPage() {
  ...
  return (
    <div className="home-page-wrapper">
      <PageMeta
        title="Duffel & Gym Bags — OEM Manufacturer from India"
        description="Factory-direct duffel and gym bag manufacturing from Punjab, India. Travel duffels, gym bags, overnight bags and cabin bags. OEM and private label. Bulk export."
        path="/duffel-gym"
      />
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-white/80">
              Bulk duffel and gym bag manufacturing for sports retailers, fitness brands and wholesale distributors. Full OEM and private label service with factory-direct pricing.
            </p>
      ...
      >
        <div className="container mx-auto px-4 lg:px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="font-serif text-3xl font-bold text-white mb-2">Duffel & Gym Bag Styles</h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <button
                  onClick={() => navigate({ to: '/contact', search: { category: 'Duffel & Gym Bags', sub: selected.name } as never })}
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <h2 className="font-serif text-3xl font-bold text-white mb-6">Built to Your Specification</h2>
              <p className="text-white/60 leading-relaxed mb-8">
                From custom colour-blocked gym bags to branded team duffels with printed names and numbers. We manufacture to your exact brief with full OEM flexibility.
              </p>
      ...
      >
        <div className="container mx-auto px-4 lg:px-6 text-center max-w-2xl mx-auto">
          ...
          <h2 className="mb-6 font-serif text-3xl md:text-4xl font-bold text-white">Interested in Our Duffel & Gym Bags?</h2>
