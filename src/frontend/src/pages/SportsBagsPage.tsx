...
const category = phase1Categories.find((c) => c.id === 'sports-bags')!;

const customOptions = [
  'Team name and player number printing',
  'Club crest embroidery or heat transfer',
  'Custom colour blocking and Pantone matching',
  'Reinforced base and heavy-duty handles',
  'Wheeled kit bag options for cricket and hockey',
  'Waterproof linings and wet-dry compartments',
  'Internal padding and dividers to spec',
  'Packaging: individual poly bag or bulk carton',
];

export default function SportsBagsPage() {
  ...
  return (
    <div className="home-page-wrapper">
      <PageMeta
        title="Sports Bags — OEM Manufacturer from India"
        description="Factory-direct sports bag manufacturing from Punjab, India. Cricket kit bags and hockey bags. OEM, team orders and bulk export."
        path="/sports-bags"
      />
      ...
      >
        <div className="container mx-auto px-4 lg:px-6">
          <div className="mx-auto max-w-3xl text-center">
            <span className="section-eyebrow">Factory Direct · OEM · Team Orders</span>
            ...
            <p className="text-lg md:text-xl leading-relaxed text-white/80">
              Specialist sports kit bags manufactured for clubs, academies, teams and sports equipment brands. Full customisation including team branding, names, numbers, and bulk production.
            </p>
      ...
      >
        <div className="container mx-auto px-4 lg:px-6">
          <div className="mb-10 text-center">
            <span className="section-eyebrow">Browse by Sport</span>
            <h2 className="font-serif text-3xl font-bold text-white mb-2">Sports Kit Bag Styles</h2>
            <p className="text-white/45 text-sm max-w-lg mx-auto">Select a sport to explore specifications, features, and minimum order details.</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <button
                  onClick={() => navigate({ to: '/contact', search: { category: 'Sports Bags', sub: selected.name } as never })}
      ...
      >
        <div className="container mx-auto px-4 lg:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              <span className="section-eyebrow">Team & Club Customisation</span>
              <h2 className="font-serif text-3xl font-bold text-white mb-6">Built for Your Team</h2>
              <p className="text-white/60 leading-relaxed mb-8">
                We manufacture bespoke sports kit bags for clubs, academies, and brands. From cricket kit bags with team crests to custom hockey bags with name printing, we manufacture exactly to your brief.
              </p>
      ...
      >
        <div className="container mx-auto px-4 lg:px-6 text-center max-w-2xl mx-auto">
          ...
          <h2 className="mb-6 font-serif text-3xl md:text-4xl font-bold text-white">Interested in Our Sports Bags?</h2>
          <p className="mb-10 text-white/65 leading-relaxed">Tell us your sport, quantity, and team customisation requirements. We'll respond within 24 hours with pricing and lead times.</p>
          <button onClick={() => navigate({ to: '/contact' })} className="home-btn-primary group">
