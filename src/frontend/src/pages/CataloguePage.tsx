      ...
      <div className="home-section-cta py-32 md:py-40">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h1 className="mb-6 font-serif text-4xl md:text-5xl font-bold text-white">Request Received!</h1>
            <p className="mb-10 text-lg md:text-xl leading-relaxed text-white/85">
              Thank you for your interest in our catalogue. We'll send you our comprehensive product
              catalogue via email within 24 hours.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row sm:gap-5 justify-center">
              <button
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-20 text-center">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-white/85">
              Get access to our comprehensive product catalogue featuring our complete range of
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full rounded-xl border border-input bg-background px-4 py-3 text-white transition-colors focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary resize-none"
                    placeholder="Any specific products or categories you're interested in? (Optional)"
                  />
                </div>
                ...
                >
                  {submitInquiry.isPending ? 'Submitting...' : 'Request Catalogue'}
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div className="home-highlight-card p-6">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full home-icon-badge">
                  <FileText className="h-6 w-6 home-icon-color" />
                </div>
                <h3 className="mb-3 text-lg font-serif font-semibold text-white">What's Included</h3>
              ...
              <div className="home-highlight-card p-6">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full home-icon-badge">
                  <Download className="h-6 w-6 home-icon-color" />
                </div>
                <h3 className="mb-3 text-lg font-serif font-semibold text-white">Digital Format</h3>
